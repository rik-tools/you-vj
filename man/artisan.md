...
| src/type/config             | OAuth2Client           | OAuth2Client           | Auth.OAuth2Client                                                                |
...
| src/app/controller | IngestingController | controlIngesting     | (string, Paths) => Promise \<void>                               |
| src/app/controller | EgestingController  | controlEgesting      | (string, string [], Paths) => Promise \<void>                    |
| src/app/service    | EgestingService     | persistPlaylistSync  | PlaylistSyncGateway => Promise \<void>                           |
| src/app/service    | IngestingService    | persistPlaylistItems | (PlaylistItemGateway, PlaylistItemRepository) => Promise \<void> |
| src/app/service    | ShowingService      | showPlaylists        | (PlaylistGateway, PlaylistConsole) => Promise \<void>            |
...
| tst/app/service             | EgestingService.test       | mockGateway                                                                                   | PlaylistSyncGateway       |
| tst/app/service             | IngestingService.test      | mockGateway                                                                                   | PlaylistItemGateway       |
| tst/app/service             | IngestingService.test      | mockRepository                                                                                | PlaylistItemRepository    |
| tst/app/service             | ShowingService.test        | mockPlaylistConsole                                                                           | PlaylistConsole           |
| tst/app/service             | ShowingService.test        | mockPlaylistGateway                                                                           | PlaylistGateway           |
| tst/adapter/outbound        | DBPlaylistItemAdapter.test | DDL_PATH                                                                                      | string                    |
| tst/adapter/outbound        | DBPlaylistItemAdapter.test | __dirname                                                                                     | string                    |
| tst/adapter/outbound        | DBPlaylistItemAdapter.test | DML_PATH                                                                                      | string                    |
| tst/adapter/outbound        | YTPlaylistAdapter.test     | client                                                                                        |                           |
| tst/adapter/outbound        | YTPlaylistAdapter.test     | mockPlaylistsList                                                                             |                           |
| tst/adapter/outbound        | YTPlaylistItemAdapter.test | client                                                                                        |                           |
| tst/adapter/outbound        | YTPlaylistItemAdapter.test | mockPlaylistItemsList                                                                         |                           |
| tst/adapter/outbound        | YTPlaylistSyncAdapter.test | client                                                                                        |                           |
| tst/adapter/outbound        | YTPlaylistSyncAdapter.test | mockPlaylistItemsInsert                                                                       |                           |
| tst/adapter/outbound        | YTPlaylistSyncAdapter.test | mockPlaylistsInsert                                                                           |                           |
| tst/adapter/outbound/oauth2 | CallbackServer.test        | fakeClient                                                                                    | OAuth2Client              |
| tst/adapter/outbound/oauth2 | CallbackServer.test        | {mockOpen, mockRequestListener}                                                               |                           |
| tst/adapter/outbound/oauth2 | Client.test                | fakeClient                                                                                    |                           |
| tst/adapter/outbound/oauth2 | Client.test                | fakeSecrets                                                                                   |                           |
| tst/adapter/outbound/oauth2 | Client.test                | {mockCredentials, mockLocallyDerivedClient, mockRemotelyDerivedClient, mockOAuth2Constructor} |                           |
| tst/adapter/outbound/oauth2 | Credentials.test           | fakeSecrets                                                                                   | Secrets                   |
| tst/adapter/outbound/oauth2 | Credentials.test           | installedCredentialsFile                                                                      | Record <string, any>      |
| tst/adapter/outbound/oauth2 | Credentials.test           | {mockReadFile}                                                                                |                           |
| tst/adapter/outbound/oauth2 | Credentials.test           | webCredentialsFile                                                                            | Record <string, any>      |
| tst/adapter/outbound/oauth2 | LocallyDerivedClient.test  | mockRefreshAccessToken                                                                        |                           |
| tst/adapter/outbound/oauth2 | LocallyDerivedClient.test  | mockSetCredentials                                                                            |                           |
| tst/adapter/outbound/oauth2 | RemotelyDerivedClient.test | {mockGenerateAuthUrl, mockCallbackServer}                                                     |                           |
| tst/adapter/outbound/oauth2 | RequestListener.test       | fakeClient                                                                                    | OAuth2Client              |
| tst/adapter/outbound/oauth2 | RequestListener.test       | {mockReadFile, mockGetToken, mockSetCredentials}                                              |                           |
